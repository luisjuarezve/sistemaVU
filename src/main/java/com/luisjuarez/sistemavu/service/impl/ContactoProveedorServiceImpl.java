...
public class ContactoProveedorServiceImpl implements ContactoProveedorService {
    ...
    @Override
    public void reporteContactoProveedorPDF(String destino) throws SQLException {
        ...
        try {
            ...
            String[] texts = {
                ...
                "REPORTE DE CONTACTOS PROVEEDOR", // Aquí puedes añadir manualmente el título del reporte
            ...
            float[] columnWidths = {
                tableWidth * 0.05f, //id
                tableWidth * 0.15f, //nombre
                tableWidth * 0.15f, //apellido
                tableWidth * 0.1f, //telefono
                tableWidth * 0.2f, //correo
                tableWidth * 0.1f, //estado
                tableWidth * 0.1f, //f. registro
                tableWidth * 0.15f //proveedor
            };
            float yPosition = 670;
            int fontSize = 8;
            ...
            for (ContactoProveedor contactoproveedor : contactoproveedores) {
                Proveedor proveedor = SistemaPrincipal.getProveedorService().buscarProveedorPorId(contactoproveedor.getProveedor_idProveedor());
                // Formatear la fecha para mostrar solo la parte de la fecha sin la hora
                SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
                String fecha = dateFormat.format(contactoproveedor.getFecha_registro());
                String estado;
                if (contactoproveedor.isEstado()) {
                    estado = "Activo";
                } else {
                    estado = "Inactivo";
                }
                ...
                String[] rows = {
                    String.valueOf(contactoproveedor.getIdContactoProveedor()),
                    contactoproveedor.getNombre(),
                    contactoproveedor.getApellido(),
                    contactoproveedor.getTelefono(),
                    contactoproveedor.getCorreo(),
                    estado,
