 ...
 * @author Helen
 */
public class Formulario_Cliente_Modificar extends javax.swing.JFrame {

    private JTable TableClientes;
    private Cliente cliente;

    public Formulario_Cliente_Modificar(JTable table, Cliente cliente) {

        initComponents();
        setClienteFields(cliente);
        this.TableClientes = table;
...
public void setClienteFields(Cliente cliente) {
        jComboBox1.setSelectedItem(cliente.getTipo_doc());
        jTextField6.setText(cliente.getNro_doc());
        ...
        jTextField5.setText(cliente.getCorreo_electronico());
        jTextArea1.setText(cliente.getNotas());
    }
}
