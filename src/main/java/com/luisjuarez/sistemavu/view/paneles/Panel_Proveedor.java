...
public class Panel_Proveedor extends javax.swing.JPanel {
    ...
    public Panel_Proveedor(Dimension Size) {
        try {
            initComponents();
    ...
    private void initComponents() {
        ...
        TableProveedor = new com.luisjuarez.sistemavu.view.components.CustomTable();
        ...
        TableProveedor.setPreferredSize(new java.awt.Dimension(600, 600));
    ...
    private void txt_buscadorFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_buscadorFocusGained
        if (txt_buscador.getText().equalsIgnoreCase("Introduce el rif o nombre del proveedor")) {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                SwingUtilities.invokeLater(() -> {
                    try {
                        SistemaPrincipal.getProveedorService().cargarTabla(TableProveedor, txt_buscador.getText());
                    } catch (SQLException ex) {
    ...
    private com.luisjuarez.sistemavu.view.components.CustomTable TableProveedor;
