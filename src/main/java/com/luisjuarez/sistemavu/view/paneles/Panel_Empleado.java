...
public class Panel_Empleado extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        TableEmpleados = new com.luisjuarez.sistemavu.view.components.CustomTable();
        ...
        separador.setPreferredSize(new java.awt.Dimension(80, 50));
        ...
        TableEmpleados.setPreferredSize(new java.awt.Dimension(600, 600));
    ...
    private void txt_buscadorFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_buscadorFocusGained
        if (txt_buscador.getText().equalsIgnoreCase("Introduce el rif o nombre del empleado")) {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                SwingUtilities.invokeLater(() -> {
                    try {
                        SistemaPrincipal.getEmpleadoService().cargarTabla(TableEmpleados, txt_buscador.getText());
                    } catch (SQLException ex) {
                        JOptionPane.showMessageDialog(null, "Error al cargar la tabla de Empleados: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                    }
                });
            }
        }, 300);
    ...
    private void txt_buscadorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_buscadorKeyPressed
        if (evt.getKeyChar() == KeyEvent.VK_ENTER) {
            if (SistemaPrincipal.getProductoService().buscarProductosPorPalabraClave(txt_buscador.getText()).isEmpty()) {
                JOptionPane.showMessageDialog(null, "Empleado no registrado en la base de datos", "Busqueda Fallida", JOptionPane.WARNING_MESSAGE);
            }
        }
    ...
    private com.luisjuarez.sistemavu.view.components.CustomTable TableEmpleados;
